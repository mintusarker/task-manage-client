        ...
        <div className='px-8'>
            ...
            >
                <Navbar.Brand href=""  className=''>
                    <span className="self-center text-green-700 text-3xl whitespace-nowrap font-semibold dark:text-white">
                        Task Management
                    </span>
                </Navbar.Brand>
                <Navbar.Toggle />
                <Navbar.Collapse>
                    ...
                    <Link to='/media'><Button className='my-2' color='light'>Task List</Button></Link>
