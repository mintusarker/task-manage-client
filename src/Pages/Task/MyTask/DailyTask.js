    ...
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 w-full mt-32 mb-56'>
            <div className='text-center'>
                <h2 className='text-2xl font-semibold text-green-600'>Manage Your Daily Task</h2>
            ...
            <div>
                <form onSubmit={handleAdd}>
                    <div className="form-control w-full max-w-xs">
                        <label className="label"><span className="label-text">Put Your Daily Task</span></label>
